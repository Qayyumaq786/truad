...
const rows = [
  createData(0, '22 Jan, 2024', 'Elvis Presley', 'Tupelo, MS', 'VISA ⠀•••• 3719', 312.44),
  createData(1, '22 Jan, 2024', 'Paul McCartney', 'London, UK', 'VISA ⠀•••• 2574', 866.99),
  createData(2, '22 Jan, 2024', 'Tom Scholz', 'Boston, MA', 'MC ⠀•••• 1253', 100.81),
  createData(3, '22 Jan, 2024', 'Michael Jackson', 'Gary, IN', 'AMEX ⠀•••• 2000', 654.39),
  createData(4, '22 Jan, 2024', 'Bruce Springsteen', 'Long Branch, NJ', 'VISA ⠀•••• 5919', 212.79),
];
        ...
        <TableBody>
          {rows.map((row) => (
            <TableRow key={row.id} >
              ...
              <TableCell align="right" style={{color: 'white',}}>{row.amount}</TableCell>
            </TableRow>
          ))}
        </TableBody>
      </Table>
